        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-12">
          <Card className="p-6 lg:col-span-2">
            <h2 className="text-2xl font-bold mb-4">
              About Basketball Training
            </h2>
            <p className="text-gray-700 mb-4">
              Basketball requires explosive jumping ability, rapid direction
              changes, and sustained energy throughout four quarters. Our
              training programs focus on developing the athletic qualities that
              separate good players from great ones.
            </p>
            <p className="text-gray-700">
              From increasing your vertical jump to improving lateral quickness
              and building basketball-specific endurance, these programs will
              help you perform at your peak on the court.
            </p>
          </Card>
